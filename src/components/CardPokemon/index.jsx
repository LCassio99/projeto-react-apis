...
const CardPokemon = ({ pokemon }) => {
  ...
  const { addPokemon, removePokemon, openDetails, pokedex } =
  ...
  useEffect(() => {
    setPokeInfos({
      ...
      image: data.sprites && data.sprites.other.dream_world.front_default,
    });
  }, [data]);
  ...
  return (
    <>
      <ContainerCard
        $bg={defineColorCard(pokeInfos.tipo1)}
      ...
      >
        <div className="card">
          ...
          {pokeInfos && (
            <img className={"pokemon"} src={pokeInfos.image} alt="pokemon" />
          )}
          ...
          <div className="types">
            <span className="tipo1">
              <img
                src={defineImageType(pokeInfos.tipo1)}
                alt="tipo do pokemon"
              />
              {pokeInfos.tipo1}
            </span>
            ...
            {pokeInfos.tipo2 && (
              <span className="tipo2">
                <img
                  src={defineImageType(pokeInfos.tipo2)}
                  alt="tipo do pokemon"
                />
                {pokeInfos.tipo2}
              </span>
